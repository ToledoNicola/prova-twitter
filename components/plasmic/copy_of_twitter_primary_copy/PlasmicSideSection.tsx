...
import sty from "./PlasmicSideSection.module.css"; // plasmic-import: Y_COCBceTE-ZK1/css
...
function PlasmicSideSection__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__z2Bpz)}>
        <div className={classNames(projectcss.all, sty.freeBox__cLmKp)}>
          {p.renderPlasmicSlot({
      ...
      <div className={classNames(projectcss.all, sty.freeBox__ereXk)}>
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Trend
                className={classNames("__wab_instance", sty.trend___6Ek1F)}
              />

              <Trend
                className={classNames("__wab_instance", sty.trend__u0SaR)}
              />
            </React.Fragment>
          ),
          value: args.slot
