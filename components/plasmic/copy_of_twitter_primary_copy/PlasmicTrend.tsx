...
import sty from "./PlasmicTrend.module.css"; // plasmic-import: JKT-Ml_ZZCz0qd/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__b1Q9)}
      >
        {p.renderPlasmicSlot({
      ...
      <div className={classNames(projectcss.all, sty.freeBox__a6Ona)}>
        <div className={classNames(projectcss.all, sty.freeBox__t7WcB)}>
          {p.renderPlasmicSlot({
            defaultContents:
