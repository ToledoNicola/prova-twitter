...
import sty from "./PlasmicActionButton.module.css"; // plasmic-import: ThTj1ia1xzyMF/css
...
function PlasmicActionButton__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__re2IG, {
          [sty.freeBoxoptions_large__re2IGzO4UO]: hasVariant(
            variants,
            "options",
            "large"
          ),
          [sty.freeBoxoptions_medium__re2IGr54Wm]: hasVariant(
            variants,
            "options",
            "medium"
          )
      ...
      >
        {(triggers.hover_root ? true : true) ? (
          <div
            className={classNames(projectcss.all, sty.freeBox__w6EF, {
              [sty.freeBoxoptions_labeled__w6EFQghtS]: hasVariant(
                variants,
                "options",
                "labeled"
              ),
              [sty.freeBoxoptions_medium__w6EFr54Wm]: hasVariant(
                variants,
                "options",
                "medium"
              )
        ...
        {p.renderPlasmicSlot({
          defaultContents: (
            <ReplyIcon
              className={classNames(projectcss.all, sty.svg__bUuFe)}
              role={"img"}
            />
          ),
