...
import sty from "./PlasmicSuggestion.module.css"; // plasmic-import: lVvWKYP_zUrgxj/css
...
function PlasmicSuggestion__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <p.PlasmicImg
              alt={""}
              className={classNames(sty.img___5YRi)}
      ...
      <div className={classNames(projectcss.all, sty.freeBox___9UutX)}>
        <div className={classNames(projectcss.all, sty.freeBox___2NlUy)}>
          <div className={classNames(projectcss.all, sty.freeBox__mKnZd)}>
            {p.renderPlasmicSlot({
        ...
        <div className={classNames(projectcss.all, sty.freeBox__ts2Ip)}>
          {p.renderPlasmicSlot({
